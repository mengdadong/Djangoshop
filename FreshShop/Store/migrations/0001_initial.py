# Generated by Django 2.1.8 on 2019-07-22 07:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_date', models.DateField(verbose_name='出厂日期')),
                ('good_safeDate', models.IntegerField(verbose_name='保质期')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsImg',
            fields=[
                ...
                ('good_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Store.Goods', verbose_name='商品')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
            fields=[
                ...
                ('Nicknaem', models.CharField(blank=True, max_length=32, null=True, verbose_name='昵称')),
                ...
                ('Picture', models.ImageField(blank=True, max_length=32, null=True, upload_to='', verbose_name='头像')),
