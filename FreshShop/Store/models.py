...
class Seller(models.Model):     #卖家
    ...
    picknaem = models.CharField(max_length=32,verbose_name="昵称",null=True,blank=True)

    phone = models.CharField(max_length=32,verbose_name="电话",null=True,blank=True)

    email = models.EmailField(verbose_name="邮箱",null=True,blank=True)

    picture = models.ImageField(max_length=32,verbose_name="头像",null=True,blank=True)
...
class Goods(models.Model):
    ...
    goods_image = models.ImageField(upload_to="store/image",verbose_name="商品图片")
...
class GoodsImg(models.Model):
    img_address = models.ImageField(upload_to="store/image",verbose_name="图片地址")
    img_description = models.TextField(max_length=32,verbose_name='图片描述')
    good_id = models.ForeignKey(to=Goods,on_delete= models.CASCADE,verbose_name="商品")
